    ...
    if (active && payload && payload.length) {
      ...
      return (
        ...
        >
          ...
          >
            <span style={{ color: payload[0].fill }}>●</span> {data.value}{" "}
            beneficiaries
          </p>
        </div>
      );
          ...
          <>
            ...
            <div className="grid grid-cols- md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <StatsCard
                ...
                data={generateSampleData(
                  analyticsData.accounts?.total_users || 0
                )}
                icon={Users}
              ...
              <StatsCard
                ...
                chartType="bar"
                data={generateSampleData(
                  analyticsData.divisions_programs?.total_programs || 0
                )}
                icon={Briefcase}
              ...
              <StatsCard
                ...
                chartType="line"
                data={generateSampleData(
                  analyticsData.divisions_programs?.total_divisions || 0
                )}
                icon={LayoutGrid}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              <DashboardCard
                ...
                value={analyticsData.grants?.total_grants?.toString() || "N/A"}
              ...
              <DashboardCard
                ...
                value={
                  analyticsData.documents?.total_documents?.toString() || "N/A"
                }
                        ...
                        <LineChart
                          data={analyticsData.documents.documents_by_type.map(
                            (item) => ({
                              ...
                              displayName: item.document_type
                                .split("_")
                                .map(
                                  (word) =>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="lg:col-span-1">
            {isLoadingTasks && (
              <div
                className={`flex justify-center items-center h-64 p-6 rounded-xl shadow-lg ${
                  theme === "light" ? "bg-white" : "bg-[var(--color-black/50)]"
                }`}
              >
                <Loader2
                  className={`w-10 h-10 animate-spin ${
            ...
            {!isLoadingTasks && !tasksError && (
              <div className="h-[550px] xl:h-[600px] border-1 border-black/50 rounded-3xl">
                {" "}
                {/* Explicit height for TasksSection */}
                <TasksSection
                  tasks={tasksData}
                  appTheme={theme}
                  showHeader={true}
          ...
          <div className="lg:col-span-1 border-1 border-black/50 rounded-3xl">
            ...
            <div className="h-[550px] xl:h-[600px]">
              {" "}
              {/* Explicit height for GrantsCalendar */}
